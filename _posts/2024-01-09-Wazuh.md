...
There's has been also an attempt to drop a cryptominer via Log4J attack ([details](https://blog.criminalip.io/2022/02/11/criminal-ip-analysis-report-on-log4j-attack-patterns/)). On Christmas day, I receive the following request against the web server: (interessante sapere se è stato rilevato da Suricata, anche se encoded)
